<!--Users will be able to either log into the manager home page if they have the proper login information, login to the user home if they are not an administrator, or create an account that will log them into the user home screen once the user completes the form.
-->
<!doctype html>
